...
class MobileNetV3BackBone(nn.Cell):
    """
...
def mobilenet_v3_backbone(model_name, **kwargs):
    """
    ...
    return MobileNetV3BackBone(model_cfgs[model_name], **kwargs)


mobilenet_v3_large = partial(mobilenet_v3_backbone, model_name="large")
mobilenet_v3_small = partial(mobilenet_v3_backbone, model_name="small")
...
class MobileNetV3Combine(nn.Cell):
    """
    MobileNetV3Combine architecture.
    ...
    def __init__(self, backbone, head):
        super(MobileNetV3Combine, self).__init__(auto_prefix=False)
...
def mobilenet_v3(backbone, head):
    return MobileNetV3Combine(backbone, head)